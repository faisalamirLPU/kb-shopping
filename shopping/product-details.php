                ...
                <div class="container px-4 px-lg-5 my-5">
                    <div class="row gx-4 gx-lg-5 align-items-center">
                        <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0"
                                ...
                                alt="<?php echo htmlentities($row['productName']); ?>" width="500" height="600"
                                style="border:solid 1px #000;" />
                            <img src="admin/productimages/<?php echo htmlentities($row['productImage2']); ?>" width="291"
                                style="border:solid 1px #000;">
                            <img src="admin/productimages/<?php echo htmlentities($row['productImage3']); ?>" width="292"
                                style="border:solid 1px #000;">

                        </div>
                        <div class="col-md-6">
                            <div class="small mb-1"><strong>Category:</strong>
                                <?php echo htmlentities($row['categoryName']); ?>
                            </div>
                            <div class="small mb-1"><strong>Sub-Category:</strong>
                            ...
                            <div class="fs-5 mb-5">
                                ...
                                <div class="small mb-1"><strong>Shipping/Delivery Chareges:</strong>
                                    <?php echo htmlentities($row['shippingCharge']); ?>
                                </div>
                            </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <img class="card-img-top"
                                src="admin/productimages/<?php echo htmlentities($row['productImage1']); ?>"
                                alt="<?php echo htmlentities($row['productName']); ?>" width="350" height="300" />
                            <!-- Product details-->
