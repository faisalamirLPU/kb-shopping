...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container px-4 px-lg-5">
        <a style="color:#DA287C " class="navbar-brand" href="index.php"><b>KB ONLINE SHOP</b></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <!-- <li><a class="nav-link active" href="index.php">All Products</a></li>
                <li><a class="nav-link active" href="shop-categories.php">Categor Wise</a></li> -->
                ...
                <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0"
                            method="post" action="search-orders.php">
                            <div class="input-group">
                                <input class="form-control" type="text" name="searchinputdata"
                                    placeholder="Search Here..." aria-label="Search for..."
